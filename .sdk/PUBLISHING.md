...
|---|---|---|
| `ts/` | @voxgig-sdk/n4chan-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/n4chan-sdk \
      --repository voxgig-sdk/n4chan-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/n4chan-sdk` shows it, and
`npm trust revoke @voxgig-sdk/n4chan-sdk --id=<id>` removes it.
