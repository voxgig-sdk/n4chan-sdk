...
class N4chanNetsimFeature extends N4chanBaseFeature
{
    ...
    private function _simulate(N4chanContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(N4chanContext $ctx, array $applied): void
    {
        $client = $this->client;
