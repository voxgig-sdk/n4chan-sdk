...
class N4chanProxyFeature extends N4chanBaseFeature
{
    ...
    public function init(N4chanContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (N4chanContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
