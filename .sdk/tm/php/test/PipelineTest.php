...
{
    private static function utility(): N4chanUtility
    {
        return new N4chanUtility();
    }
    ...
    private static function ctx(array $over = []): N4chanContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new N4chanContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new N4chanOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof N4chanError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new N4chanOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = N4chanMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new N4chanOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = N4chanMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new N4chanOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = N4chanMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new N4chanSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = N4chanMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = N4chanMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new N4chanSpec(['step' => 's']),
            'response' => new N4chanResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new N4chanResult([]),
        ]);
        [, $err] = N4chanMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new N4chanSpec(['step' => 's']),
            'response' => new N4chanResponse(self::resp(200, ['v' => 1])),
            'result' => new N4chanResult([]),
        ]);
        [, $err] = N4chanMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new N4chanSpec(['step' => 's']),
            'response' => new N4chanResponse(self::resp(200, ['v' => 2])),
            'result' => new N4chanResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        N4chanMakeResponse::call($ctx);
    ...
    {
        $preset = new N4chanResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new N4chanSpec([]),
            'response' => new N4chanResponse([]),
            'result' => new N4chanResult([]),
        ...
        [$got, $err] = N4chanMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new N4chanResult([])]);
        [, $err] = N4chanMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new N4chanSpec([]), 'result' => null]);
        [, $err] = N4chanMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new N4chanSpec(['step' => 's']),
            'result' => new N4chanResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new N4chanOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = N4chanMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new N4chanSpec(['step' => 's']),
            'result' => new N4chanResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new N4chanOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = N4chanMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new N4chanResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new N4chanSpec([]),
            'result' => new N4chanResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = N4chanMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = N4chanMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new N4chanError('boom', 'boom');
        $utility->fetcher = function (N4chanContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new N4chanSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = N4chanMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (N4chanContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = N4chanMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(N4chanResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (N4chanContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new N4chanSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = N4chanMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new N4chanResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new N4chanSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = N4chanMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = N4chanMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = N4chanMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new N4chanResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, N4chanDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new N4chanResult(['ok' => false])]);
        $this->expectException(N4chanError::class);
        N4chanDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new N4chanResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', N4chanMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new N4chanBaseFeature();
        $b = new N4chanBaseFeature();
        N4chanFeatureAdd::call($ctx, $a);
        N4chanFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): N4chanBaseFeature
    {
        $f = new N4chanBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        N4chanFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): N4chanContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new N4chanSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = N4chanPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new N4chanResponse(['headers' => null]),
            'result' => new N4chanResult([]),
        ]);
        N4chanResultHeaders::call($ctx);
