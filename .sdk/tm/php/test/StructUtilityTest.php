...
// N4chan SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = N4chanOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(N4chanOmni::structfix($now, Struct::undef()))
                        !== json_encode(N4chanOmni::structfix($val, Struct::undef()))) {
