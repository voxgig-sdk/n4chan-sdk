...
class N4chanFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; N4chanSDK/1.0)';
    ...
    public static function call(N4chanContext $ctx, string $fullurl, array $fetchdef): array
    {
