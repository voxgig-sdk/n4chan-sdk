...
class N4chanTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = N4chanTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = N4chanTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = N4chanTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
