...
func registerSDKWords(r *eng.Registry, client *sdk.N4chanSDK) {
...
func runOp(client *sdk.N4chanSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
