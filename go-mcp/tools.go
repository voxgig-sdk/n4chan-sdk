...
type Args struct {
	Entity string         `json:"entity" jsonschema:"archive | board | catalog | index | thread"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.N4chanSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "n4chan_list",
		Description: "List records from N4chan. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "n4chan_load",
		Description: "Load a single record from N4chan. " +
...
func runOp(client *sdk.N4chanSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.N4chanSDK, name string) (sdk.N4chanEntity, error) {
	switch strings.ToLower(name) {
	case "archive":
		return client.Archive(nil), nil
	case "board":
