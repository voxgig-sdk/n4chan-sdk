...
func (sdk *N4chanSDK) OptionsMap() map[string]any {
...
func (sdk *N4chanSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *N4chanSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *N4chanSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *N4chanSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *N4chanSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *N4chanSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("N4chanSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *N4chanSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *N4chanSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("N4chanSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
