...
import (
	...
	vs "github.com/voxgig-sdk/n4chan-sdk/go/utility/struct"
)

type ArchiveEntity struct {
	name    string
	client  *core.N4chanSDK
...
func NewArchiveEntity(client *core.N4chanSDK, entopts map[string]any) *ArchiveEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArchiveEntity) GetName() string { return e.name }
...
func (e *ArchiveEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArchiveEntity) Deleted() bool {
	return e.deleted
}


func (e *ArchiveEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArchiveEntity(e.client, opts)
}

func (e *ArchiveEntity) Data(args ...any) any {
...
func (e *ArchiveEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Archive; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArchiveEntity) DataTyped(data ...Archive) Archive {
	if len(data) > 0 {
		return typedFrom[Archive](e.Data(asMap(data[0])))
	}
	return typedFrom[Archive](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Archive (all fields
// optional at the wire level).
func (e *ArchiveEntity) MatchTyped(match ...Archive) Archive {
	if len(match) > 0 {
		return typedFrom[Archive](e.Match(asMap(match[0])))
	}
	return typedFrom[Archive](e.Match())
}
...
func (e *ArchiveEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArchiveEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ArchiveEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArchiveListMatch and returns []Archive. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ArchiveEntity) ListTyped(reqmatch ArchiveListMatch, ctrl map[string]any) ([]Archive, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Archive](res), nil
}



func (e *ArchiveEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArchiveEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArchiveEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArchiveEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
