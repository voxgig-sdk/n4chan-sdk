...
func NewBoardEntity(client *core.N4chanSDK, entopts map[string]any) *BoardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BoardEntity) GetName() string { return e.name }
...
func (e *BoardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BoardEntity) Deleted() bool {
	return e.deleted
}


func (e *BoardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBoardEntity(e.client, opts)
}

func (e *BoardEntity) Data(args ...any) any {
...
func (e *BoardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Board; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BoardEntity) DataTyped(data ...Board) Board {
	if len(data) > 0 {
		return typedFrom[Board](e.Data(asMap(data[0])))
	}
	return typedFrom[Board](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Board (all fields
// optional at the wire level).
func (e *BoardEntity) MatchTyped(match ...Board) Board {
	if len(match) > 0 {
		return typedFrom[Board](e.Match(asMap(match[0])))
	}
	return typedFrom[Board](e.Match())
}
...
func (e *BoardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BoardEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BoardEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BoardListMatch and returns []Board. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BoardEntity) ListTyped(reqmatch BoardListMatch, ctrl map[string]any) ([]Board, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Board](res), nil
}



func (e *BoardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BoardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BoardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BoardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
