...
func NewCatalogEntity(client *core.N4chanSDK, entopts map[string]any) *CatalogEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CatalogEntity) GetName() string { return e.name }
...
func (e *CatalogEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CatalogEntity) Deleted() bool {
	return e.deleted
}


func (e *CatalogEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCatalogEntity(e.client, opts)
}

func (e *CatalogEntity) Data(args ...any) any {
...
func (e *CatalogEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Catalog; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CatalogEntity) DataTyped(data ...Catalog) Catalog {
	if len(data) > 0 {
		return typedFrom[Catalog](e.Data(asMap(data[0])))
	}
	return typedFrom[Catalog](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Catalog (all fields
// optional at the wire level).
func (e *CatalogEntity) MatchTyped(match ...Catalog) Catalog {
	if len(match) > 0 {
		return typedFrom[Catalog](e.Match(asMap(match[0])))
	}
	return typedFrom[Catalog](e.Match())
}
...
func (e *CatalogEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CatalogEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CatalogEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CatalogListMatch and returns []Catalog. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CatalogEntity) ListTyped(reqmatch CatalogListMatch, ctrl map[string]any) ([]Catalog, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Catalog](res), nil
}



func (e *CatalogEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CatalogEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CatalogEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CatalogEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
