...
const testSeed = `map[string]any{"entity": map[string]any{"archive": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "board": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "catalog": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "index": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "thread": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
