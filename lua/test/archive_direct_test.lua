...
describe("ArchiveDirect", function()
  it("should direct-list-archive", function()
    local setup = archive_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-archive", setup.live and "live" or "unit")
...
function archive_direct_setup(mockres)
