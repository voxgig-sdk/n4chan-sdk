...
describe("BoardDirect", function()
  it("should direct-list-board", function()
    local setup = board_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-board", setup.live and "live" or "unit")
...
function board_direct_setup(mockres)
