...
describe("CatalogDirect", function()
  it("should direct-list-catalog", function()
    local setup = catalog_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-catalog", setup.live and "live" or "unit")
