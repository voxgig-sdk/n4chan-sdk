...
describe("ThreadDirect", function()
  it("should direct-list-thread", function()
    local setup = thread_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-thread", setup.live and "live" or "unit")
...
function thread_direct_setup(mockres)
