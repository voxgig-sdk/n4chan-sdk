...
class ArchiveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ArchiveEntity($this->_client, $opts);
    }

    /**
     * @param Archive|array $args Archive data (assoc-array) to store.
     */
    ...
    /**
     * @return Archive|array The current Archive data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Archive fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Archive fields).
     */
     ...
     *
     * @param ArchiveListMatch|array|null $reqmatch Match filter (any subset
     *   of Archive fields) as an assoc-array; ArchiveListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Archive[]|array A list of Archive items as assoc-arrays at
