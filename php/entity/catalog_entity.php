...
class CatalogEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CatalogEntity($this->_client, $opts);
    }

    /**
     * @param Catalog|array $args Catalog data (assoc-array) to store.
     */
    ...
    /**
     * @return Catalog|array The current Catalog data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Catalog fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Catalog fields).
     */
     ...
     *
     * @param CatalogListMatch|array|null $reqmatch Match filter (any subset
     *   of Catalog fields) as an assoc-array; CatalogListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Catalog[]|array A list of Catalog items as assoc-arrays at
