...
class N4chanCacheFeature extends N4chanBaseFeature
{
    ...
    private function _through(N4chanContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
