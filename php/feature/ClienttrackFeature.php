...
// N4chan SDK clienttrack feature
...
class N4chanClienttrackFeature extends N4chanBaseFeature
{
    ...
    public function PostConstruct(N4chanContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'N4chan-SDK';
