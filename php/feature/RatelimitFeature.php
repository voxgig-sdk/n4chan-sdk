...
class N4chanRatelimitFeature extends N4chanBaseFeature
{
    ...
    private function _acquire(N4chanContext $ctx): void
    {
    ...
    private function _track(N4chanContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
