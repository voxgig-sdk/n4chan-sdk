...
class N4chanRbacFeature extends N4chanBaseFeature
{
    ...
    private function _required(N4chanContext $ctx): ?string
    {
    ...
    private function _reject(N4chanContext $ctx, string $required): void
    {
    ...
    private function _track(N4chanContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
