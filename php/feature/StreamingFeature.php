...
class N4chanStreamingFeature extends N4chanBaseFeature
{
    ...
    private function _iterate(N4chanResult $result): \Generator
    {
    ...
    private function _streamable(N4chanContext $ctx): bool
    {
