...
// N4chan SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class N4chanTestFeature extends N4chanBaseFeature
{
    ...
    public function init(N4chanContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (N4chanContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (N4chanContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(N4chanContext $ctx, $op, $args): array
    {
