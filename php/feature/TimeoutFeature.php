...
class N4chanTimeoutFeature extends N4chanBaseFeature
{
    ...
    private function _with_timeout(N4chanContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(N4chanContext $_ctx, float $ms): void
    {
        $client = $this->client;
