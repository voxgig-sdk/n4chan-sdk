...
class ArchiveDirectTest extends TestCase
{
    public function test_direct_list_archive(): void
    {
        $setup = archive_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-archive", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
