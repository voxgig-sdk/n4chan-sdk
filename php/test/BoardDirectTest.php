...
class BoardDirectTest extends TestCase
{
    public function test_direct_list_board(): void
    {
        $setup = board_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-board", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
