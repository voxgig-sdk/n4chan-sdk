...
// N4chan SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (N4chanSDK::test)
...
{
    private const SDK_CLASS = 'N4chanSDK';
    ...
    private const SDK_BASE = 'n4chan_sdk';
