...
class N4chanTestRunner
{
    ...
    {
        $live = self::getenv('N4CHAN_TEST_LIVE');
        $override = self::getenv('N4CHAN_TEST_OVERRIDE');
        ...
        $explain = self::getenv('N4CHAN_TEST_EXPLAIN');
...
class_alias('N4chanTestRunner', 'Runner');
class_alias('N4chanHelpers', 'Helpers');
