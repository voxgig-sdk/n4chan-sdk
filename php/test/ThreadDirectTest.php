...
class ThreadDirectTest extends TestCase
{
    public function test_direct_list_thread(): void
    {
        $setup = thread_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-thread", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
