...
// N4chan SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class N4chanParam
{
    public static function call(N4chanContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = N4chanHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
