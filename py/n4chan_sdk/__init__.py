...
from n4chan_sdk.utility import register

# Load features
from n4chan_sdk.feature.base_feature import N4chanBaseFeature
from n4chan_sdk.features import _has_feature, _make_feature
...
class N4chanSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("N4chanSDK: graphql: " + str(msg))
            res["graphql"] = errors
