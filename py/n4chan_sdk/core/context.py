...
from n4chan_sdk.core.helpers import get_ctx_prop, to_map
...
class N4chanContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, N4chanResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return N4chanError(code, msg, self)
