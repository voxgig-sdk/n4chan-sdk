...
from n4chan_sdk.core.spec import N4chanSpec
from n4chan_sdk.core.result import N4chanResult
from n4chan_sdk.core.response import N4chanResponse
from n4chan_sdk.core.operation import N4chanOperation
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = N4chanSDK.test(None, None)
        ...
        class TestInitFeature(N4chanBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(N4chanBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = N4chanSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = N4chanSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = N4chanSDK.test(None, setup_opts)
