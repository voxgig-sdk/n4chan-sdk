...
_runner = makeRunner(TEST_JSON_FILE, N4chanSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = N4chanSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = N4chanSDK.test(None, setup.get('a') or {})
