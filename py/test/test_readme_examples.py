# N4chan SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions N4chanSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both N4chanSDK(...) and N4chanSDK.test(...) become
#      N4chanSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "n4chan_sdk"
_SDK_CLASS = "N4chanSDK"
