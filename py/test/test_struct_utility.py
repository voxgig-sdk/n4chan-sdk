...
from n4chan_sdk.utility.voxgig_struct.voxgig_struct import (
...
runner = makeRunner(STRUCT_TEST_JSON, N4chanSDK.test(None, None))
...
class TestStructUtility(unittest.TestCase):
    ...
    def test_minor_joinurl(self):
        from n4chan_sdk.utility.voxgig_struct.voxgig_struct import join as struct_join
