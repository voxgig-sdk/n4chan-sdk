...
class ArchiveEntity
  ...
  def make
    opts = @_entopts.dup
    ArchiveEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ArchiveListMatch, Hash, nil] match filter (any subset of
  #   Archive fields); defaults to nil, treated as an empty match that lists all.
