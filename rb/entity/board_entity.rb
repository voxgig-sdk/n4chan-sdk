...
class BoardEntity
  ...
  # @return [Board, Hash] the current Board data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Board fields)
  def match_get
  ...
  #
  # @param reqmatch [BoardListMatch, Hash, nil] match filter (any subset of
  #   Board fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Board>, Array] the matching Board items; raises N4chanError on failure
