...
class CatalogEntity
  ...
  def make
    opts = @_entopts.dup
    CatalogEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CatalogListMatch, Hash, nil] match filter (any subset of
  #   Catalog fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Catalog>, Array] the matching Catalog items; raises N4chanError on failure
