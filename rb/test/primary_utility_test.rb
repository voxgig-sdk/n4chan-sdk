...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = N4chanOmni.make_runner(TEST_JSON_FILE, N4chanSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : N4chanOmni.errify(err)
    end
