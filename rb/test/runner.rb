...
module N4chanTestRunner
  ...
  def self.env_override(m)
    live = getenv("N4CHAN_TEST_LIVE")
    override = getenv("N4CHAN_TEST_OVERRIDE")
    ...
    explain = getenv("N4CHAN_TEST_EXPLAIN")
    m["N4CHAN_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = N4chanTestRunner
Helpers = N4chanHelpers
Vs = VoxgigStruct
