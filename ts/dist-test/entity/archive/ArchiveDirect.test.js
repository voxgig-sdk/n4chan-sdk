...
(0, node_test_1.describe)('ArchiveDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-archive', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-archive', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["board01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['N4CHAN_TEST_ARCHIVE_ENTID'];
...
//# sourceMappingURL=ArchiveDirect.test.js.map