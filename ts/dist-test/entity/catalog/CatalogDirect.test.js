...
(0, node_test_1.describe)('CatalogDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-catalog', async (t) => {
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['N4CHAN_TEST_CATALOG_ENTID'];
...
//# sourceMappingURL=CatalogDirect.test.js.map