...
(0, node_test_1.describe)('IndexDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-index', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-index', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["board01", "page01"]))
            return;
        ...
        if (setup.live) {
            ...
            params.page = setup.idmap['page01'];
        }
        else {
            params.board = 'direct01';
            params.page = 'direct02';
        }
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['N4CHAN_TEST_INDEX_ENTID'];
