...
(0, node_test_1.describe)('ThreadDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-thread', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-thread', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["board01", "thread01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.N4chanSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['N4CHAN_TEST_THREAD_ENTID'];
    ...
    const client = new __1.N4chanSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ThreadDirect.test.js.map