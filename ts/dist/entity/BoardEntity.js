...
class BoardEntity extends N4chanEntityBase_1.N4chanEntityBase {
    ...
    make() {
        return new BoardEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Board[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
