...
class CatalogEntity extends N4chanEntityBase_1.N4chanEntityBase {
    ...
    make() {
        return new CatalogEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Catalog[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
