...
describe('ArchiveDirect', async () => {
  ...
  test('direct-list-archive', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-archive', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['N4CHAN_TEST_ARCHIVE_ENTID']
